...
const URGENCY_STYLE = {
  high: {
    bg: "var(--urgent-high-bg)",
    fg: "var(--urgent-high-ink)",
    ring: "var(--urgent-high-ring)",
  },
  medium: {
    bg: "var(--urgent-medium-bg)",
    fg: "var(--urgent-medium-ink)",
    ring: "var(--urgent-medium-ring)",
  },
  low: {
    bg: "var(--urgent-low-bg)",
    fg: "var(--urgent-low-ink)",
    ring: "var(--urgent-low-ring)",
  },
  none: {
    bg: "var(--urgent-none-bg)",
    fg: "var(--urgent-none-ink)",
    ring: "var(--urgent-none-ring)",
  },
};
    ...
    <div className="flex items-center gap-1.5 flex-wrap w-full ">
      ...
      >
        <span className="mr-0.5">
          {symbolFor("enjoyment", task.enjoyment ?? 3)}
        </span>
        {task.enjoyment ?? 3}
      </Chip>
      ...
      >
        <span className="mr-0.5">
          {symbolFor("friction", task.friction ?? 3)}
        </span>
        {task.friction ?? 3}
      </Chip>
...
const STOPS = {
  blue: {
    100: "var(--cat-blue-tint)",
    600: "var(--cat-blue-solid)",
    800: "var(--cat-blue-ink)",
  },
  pink: {
    100: "var(--cat-pink-tint)",
    600: "var(--cat-pink-solid)",
    800: "var(--cat-pink-ink)",
  },
  coral: {
    100: "var(--cat-coral-tint)",
    600: "var(--cat-coral-solid)",
    800: "var(--cat-coral-ink)",
  },
  amber: {
    100: "var(--cat-amber-tint)",
    600: "var(--cat-amber-solid)",
    800: "var(--cat-amber-ink)",
  },
  green: {
    100: "var(--cat-green-tint)",
    600: "var(--cat-green-solid)",
    800: "var(--cat-green-ink)",
  },
  teal: {
    100: "var(--cat-teal-tint)",
    600: "var(--cat-teal-solid)",
    800: "var(--cat-teal-ink)",
  },
  purple: {
    100: "var(--cat-purple-tint)",
    600: "var(--cat-purple-solid)",
    800: "var(--cat-purple-ink)",
  },
  gray: {
    100: "var(--cat-gray-tint)",
    600: "var(--cat-gray-solid)",
    800: "var(--cat-gray-ink)",
  },
};
  ...
  return (
    <span
      ...
      style={{
        ...
        color: fg,
        ...(active
          ? { boxShadow: `0 0 0 2px ${ringColor}`, transform: "scale(1.06)" }
          : {}),
        ...style,
      }}
