  ...
  return (
    <div>
      ...
      <ul className="space-y-1.5">
        {active.map((cat) => {
          const stops =
            CATEGORY_COLOR_STOPS[cat.color] ?? CATEGORY_COLOR_STOPS.gray;
      ...
      <div className="rounded-lg border border-dashed border-gray-300 dark:border-gray-600 p-3 mt-4">
        <div className="flex items-center gap-2">
          <input
            ...
            onBlur={() => {
              // allow clicking a color before hiding
              setTimeout(() => setNewLabelFocused(false), 100);
            }}
            onKeyDown={(e) => {
